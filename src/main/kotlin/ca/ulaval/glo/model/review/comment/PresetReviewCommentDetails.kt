...
class PresetReviewCommentDetails {
    val cleanCodeC1InappropriateInformation =
    ...
    val cleanCodeE1BuildRequiresMoreThanOneStep =
        ReviewCommentDetails(
    ...
    val cleanCodeE2TestsRequireMoreThanOneStep =
        ReviewCommentDetails(
    ...
    val cleanCodeG1MultipleLanguagesInOneSourceFile =
        ReviewCommentDetails(
    ...
    val cleanCodeG2ObviousBehaviorIsUnimplemented =
        ReviewCommentDetails(
    ...
    val cleanCodeG3IncorrectBehaviorAtTheBoundaries =
        ReviewCommentDetails(
    ...
    val cleanCodeT4AnIgnoredTestIsAQuestionAboutAnAmbiguity =
        ReviewCommentDetails(
    ...
    val cleanCodeT6ExhaustivelyTestNearBugs =
        ReviewCommentDetails(
            "[T6] - Exhaustively Test Near Bugs",
            "Bugs tend to congregate. When you find a bug in a function, it is wise to do an exhaustive test of that function. You’ll probably find that the bug was not alone.",
            CLEAN_CODE_TAGS
        )
    val cleanCodeT7PatternsOfFailureAreRevealing =
        ReviewCommentDetails(
    ...
    val cleanCodeT8TestCoveragePatternsCanBeRevealing =
        ReviewCommentDetails(
